...
def save(list):
    codecs.open("out.txt","a",encoding="UTF-8").write("|".join(list)+"\n")
...
for file in os.listdir():
    ...
    bar.update(i)
    start = time()
    body = codecs.open(file,'r',encoding='UTF-8').read()
    threading.Thread(target=filt, args=(body,korean,)).start()
    del body, start
